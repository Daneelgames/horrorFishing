...
public class CiDyRoad : MonoBehaviour {
    ...
    [SerializeField]
    int[] blendingTerrains;//Stored Ids of the Terrains this Road is blending to currently.
    //Match Terrain
    ...
    public void InitilizeRoad(Vector3[] rawPath, float newWidth, int newSegmentLength, int newFlatAmount, CiDyNode newA, CiDyNode newB, GameObject holder, CiDyGraph newGraph, bool normalizePath){
        ...
        if (spawnerSplines == null || spawnerSplines.Count == 0) {
            AddSpawnSpline();
            //Set first one
            spawnerSplines[0].spawnType = CiDySpawner.SpawnerType.RoadMarkings;
            spawnerSplines[0].Generate();
        }
	}
	...
	*/
    ...
    public void SnipRoadMesh()
    {
        ...
        for (int i = 0; i < tmpPoints.Count; i++)
        {
            ...
            {
                Debug.Log("Minor Road Merge, Line Test?");
        ...
        if (crossWalksAtIntersections)
        {
            ...
            {
                //Node A will Need a Cross Walk.
                //End Points on Node A Side
                //Line A verts[0] - verts[2]
                //Line B verts[1] - verts[3]
            ...
            {
                //Node B will Need a Cross Walk.
                //End Points on Node B Side
                //Line A verts[0] - verts[2]
                //Line B verts[1] - verts[3]
